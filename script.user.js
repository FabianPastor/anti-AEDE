  ...
  var parseList = function(list){
    return list.split('\n').filter(function(domain){
      ...
      checklinks = function(regexps){
        ...
        checklinksinterval=setInterval(function(){
          ...
          if(contador++>=GM_getValue('number_iterations')){
            ...
            $("#fabi_cont")[0].style.backgroundColor="rgba(255, 0, 0, 0.3)";
          }
      ...
      main = function(regexps){
        ...
        $("body").append('<div id="fabi_cont" style="background-color:'+green+';z-index:2147483647;position:fixed;bottom:2px;left:2px;width:40px;height:20px;text-align:center;" >0</div>');


        checklinks(regexps);

        $("#fabi_cont").click(function(){
